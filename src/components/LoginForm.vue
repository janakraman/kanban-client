<template>
  <div>
    ...
    <form>
      ...
      <button type="submit" class="btn custom-color-1" @click.prevent="login">
        Login
      </button>
      <button
        type="submit"
      ...
      <div class="signup-buttons btn bg-light" @click.prevent="loginWithGoogle">
        <span class="google-signup text-decoration-none">
          <svg
